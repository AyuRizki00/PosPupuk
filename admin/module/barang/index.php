                            ...
                            <tr>
                                ...
                                <td style="width: 105px;">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <a href="index.php?page=barang/edit&barang=<?php echo $isi['id_barang']; ?>"><button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button></a>
                                        <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang']; ?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button></a>
                                    <?php } ?>
                            </tr>
                        <?php
                            $no++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="suplayer" class="form-control" required>
                                            ...
                                            <?php $kat = $lihat->suplayer();
                                            foreach ($kat as $isi) {     ?>
                                                <option value="<?php echo $isi['id_suplayer']; ?>">
                                                    <?php echo $isi['nama_suplayer']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
