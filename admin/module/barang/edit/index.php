 				...
 				<tr>
 					...
 					<td>
 						<select name="suplayer" class="form-control">
 							<option value="<?php echo $hasil['id_suplayer']; ?>"><?php echo $hasil['nama_suplayer']; ?></option>
 							<option value="#">Pilih suplayer</option>
 							<?php $kat = $lihat->suplayer();
								foreach ($kat as $isi) {     ?>
 								<option value="<?php echo $isi['id_suplayer']; ?>"><?php echo $isi['nama_suplayer']; ?></option>
 							<?php } ?>
 						</select>
 					</td>
 				</tr>
 				...
 				<tr>
 					...
 					<td>
 						<select name="satuan" class="form-control">
 							<option value="<?php echo $hasil['id_satuan']; ?>"><?php echo $hasil['nama_satuan']; ?></option>
