...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">POS Pupuk<sup></sup></div>
    </a>
    <!-- Divider -->
        ...
        <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="index.php?page=kategori">Kategori Barang </a>
                    <a class="collapse-item" href="index.php?page=satuan">Kategori Satuan</a>
                    <a class="collapse-item" href="index.php?page=suplayer">Distributor</a>
                    <a class="collapse-item" href="index.php?page=login">Tambah User</a>
