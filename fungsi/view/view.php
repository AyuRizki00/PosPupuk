...
class view
{
    ...
    {
        $sql = "SELECT barang.*, kategori.id_kategori, kategori.nama_kategori, satuan.id_satuan, satuan.nama_satuan, suplayer.nama_suplayer
        FROM barang
        INNER JOIN kategori ON barang.id_kategori = kategori.id_kategori
        INNER JOIN satuan ON barang.id_satuan = satuan.id_satuan
        INNER JOIN suplayer ON barang.id_suplayer = suplayer.id_suplayer
        ORDER BY id DESC";
        $row = $this->db->prepare($sql);
        $row->execute();
        $hasil = $row->fetchAll();
    ...
    {
        $sql = "SELECT barang.*, kategori.id_kategori, kategori.nama_kategori, satuan.nama_satuan, suplayer.nama_suplayer
            FROM barang
            INNER JOIN kategori ON barang.id_kategori = kategori.id_kategori
            INNER JOIN satuan ON barang.id_satuan = satuan.id_satuan
            INNER JOIN suplayer ON barang.id_suplayer = suplayer.id_suplayer
